...
const STATIC_PAGES = {
  "/": {
    ...
    description:
      "Ultimate Toolkit — набор онлайн-инструментов: генератор паролей, никнеймов, таймеры, рандомайзер, колесо фортуны и отчёт до даты.",
  ...
  "/password": {
    ...
    description:
      "Генератор надёжных паролей онлайн. Создание сложных и безопасных паролей для любых нужд.",
  ...
  "/nick": {
    title: "Никнеймы онлайн — генератор имён",
    description:
      "Генератор уникальных никнеймов для игр, соцсетей и любых платформ.",
    h1: "Генератор никнеймов"
  },
  ...
  "/stopwatch": {
    title: "Секундомер онлайн",
    description:
      "Секундомер для точного измерения времени. Работает онлайн, без регистрации.",
    h1: "Секундомер онлайн"
  },

  "/clock-live": {
    title: "Мировое время онлайн",
    description:
      "Показ текущего времени по всему миру. Онлайн часы для любого города.",
    h1: "Мировое время"
  }
};
